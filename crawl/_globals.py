...
QUERY_FOLDER = os.environ.get(
    "QUERY_FOLDER",
    pathlib.Path("files/querys")
)
RESOURCES_OUT_FOLDER = os.environ.get(
    "RESOURCES_OUT_FOLDER",
    pathlib.Path("files/resources")
)
SEARCH_RESULT_OUT_FOLDER = os.environ.get(
    "SEARCH_RESULT_OUT_FOLDER",
    pathlib.Path("files/search-results")
)
