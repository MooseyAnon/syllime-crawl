...
ERROR_DIR = os.environ.get(
    "ERROR_DIR",
    pathlib.Path("files/html-error-dumps")
)
ERROR_URL_FILE = os.environ.get(
    "ERROR_URL_FILE",
    pathlib.Path("files/error-urls.json")
)
TEST_FILE_DIR = os.environ.get(
    "TEST_FILE_DIR",
    pathlib.Path("tests")
)
